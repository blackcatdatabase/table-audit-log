...
> Lineage: 1 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 3 · Changelog: fresh
...
- id (key)
- ip_bin_key_version (key)
- record_id (key)

## Usage
```bash
# Install/upgrade schema
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package audit-log -Apply
