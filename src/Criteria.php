...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'table_name', 'record_id', 'changed_by', 'change_type', 'changed_at', 'user_agent', 'request_id' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\AuditLog\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\AuditLog\Definitions::softDeleteColumn();
