...
use BlackCat\Database\Packages\AuditLog\Repository\AuditLogRepository as GeneratedRepository;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof AuditLogRepositoryInterface) {
            ...
            throw new \InvalidArgumentException('Expected AuditLogRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\AuditLog\Dto\AuditLogDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\AuditLog\Dto\AuditLogDto|null { return $this->repo->getById($id, $asDto); }
