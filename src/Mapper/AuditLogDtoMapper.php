...
namespace BlackCat\Database\Packages\AuditLog\Mapper;

use BlackCat\Database\Packages\AuditLog\Dto\AuditLogDto;
use BlackCat\Database\Packages\AuditLog\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO AuditLogDto:
...
final class AuditLogDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'table_name' => 'tableName', 'record_id' => 'recordId', 'changed_by' => 'changedBy', 'change_type' => 'changeType', 'old_value' => 'oldValue', 'new_value' => 'newValue', 'changed_at' => 'changedAt', 'ip_bin' => 'ipBin', 'ip_bin_key_version' => 'ipBinKeyVersion', 'user_agent' => 'userAgent', 'request_id' => 'requestId' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'record_id', 'changed_by' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'old_value', 'new_value' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'changed_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'ip_bin' ];
     ...
     * @return AuditLogDto
     */
    public static function fromRow(array $row): AuditLogDto
    {
        /** @var AuditLogDto */
    ...
    public static function fromRowOrNull(?array $row): ?AuditLogDto
    {
     ...
     */
    public static function toRow(AuditLogDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(AuditLogDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(AuditLogDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,AuditLogDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,AuditLogDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(AuditLogDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,AuditLogDto>
     */
