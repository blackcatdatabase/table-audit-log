...
final class AuditLogModule implements ModuleInterface
{
    public function name(): string { return 'table-audit_log'; }
    public function table(): string { return 'audit_log'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_audit_changed_at', 'idx_audit_request_id', 'idx_audit_table_record' ];
        $expectedFk  = [ 'fk_audit_log_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_audit_changed_at', 'idx_audit_request_id', 'idx_audit_table_record' ],
            'foreignKeys' => [ 'fk_audit_log_user' ],
        ];
    }
}
